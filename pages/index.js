  ...
  return (
    <div className={styles.container}>
      <Head>
        ...
        <meta name="description" content=" An Open Music Label project that combines the idea of Music Distribution, Marketing and Defi." />
      ...
      <footer className={styles.footer}>
        ...
        >
          &copy; 2022 Muse Defi Network <span className={styles.ftitle}>
          </span>
        </a>
      </footer>
    </div>
